...
Route::group(['prefix' => 'admindash'],function(){
...
})->name('classBases.list');

Route::resource('classBases',ClassBaseController::class);

//口语对话管理
Route::get('dialogue/dialogues',function(){
    return view('pages.dialogue.list',['dialogueList'=>DialogueBase::orderBY('created_at','desc')->paginate(100)]);
})->name('dialogue.list');

Route::resource('dialogue',DialogueBasesController::class);

//图文内容
Route::get('dialogueWords/list',function(){
    return view('pages.dialogue-words.list',['dialogueWordsList'=>DialogueWords::orderBY('created_at','desc')->get()]);
})->name('dialogueWords.list');

Route::resource('dialogueWords',DialogueWordsController::class);

//影视内容
Route::get('dialogueVideos/list',function(){
    return view('pages.dialogue_videos.list',['dialogueVideosList'=>DialogueVideo::orderBY('created_at','desc')->get()]);
})->name('dialogueVideos.list');

Route::resource('dialogueVideos',DialogueVideosController::class);
